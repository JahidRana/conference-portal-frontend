...
import "./TouristPlace.css"; // Ensure the correct path
    ...
    const fetchAccommodations = async () => {
      try {
        ...
        const response = await axios.get(
            `${process.env.REACT_APP_BACKEND_SERVER_URL}/api/v1/admin/tourist-places` // Correct spelling
          );


     
        setAccommodations(response.data.touristPlaces || []); // Set accommodations
